  ...
  return (
    <header className="sticky top-0 z-20 flex h-[60px] items-center justify-between border-b border-steel-200/60 bg-white/95 px-4 backdrop-blur-md sm:px-6">
      <div className="flex items-center gap-3">
        <button
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-steel-500 transition-colors hover:bg-steel-100 hover:text-steel-700 lg:hidden"
        ...
        <button
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-steel-500 transition-colors hover:bg-steel-100 hover:text-steel-700"
          onClick={() => navigate(-1)}
          aria-label="Go back"
        >
          <ArrowLeft className="h-5 w-5" />
        </button>
        <h1 className="min-w-0 truncate font-display text-[15px] font-semibold text-steel-900">{title}</h1>
      </div>

      <div className="flex items-center gap-1">
        <button
          className="hidden h-10 w-10 items-center justify-center rounded-lg text-steel-400 transition-colors hover:bg-steel-100 hover:text-steel-600 sm:flex"
        ...
        <div className="relative">
          <button
            ...
            className="flex min-h-10 items-center gap-2.5 rounded-lg px-1.5 py-1 transition-colors hover:bg-steel-50 sm:px-2"
          >
